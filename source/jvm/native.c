#include "native.h"
#include "extensions/native_gx.h"
...
static struct Native {
    ...
    [GRAPHICS_GX] = (struct Native[])
    {
        {"position3i", nat_gx_position3i},
        {"position3f", nat_gx_position3f},
        {"normal1x", nat_gx_normal1x},
        {"color4i", nat_gx_color4i},
        {"texcoord2i", nat_gx_texcoord2i},
    },
};
