...
blockproperties_t block_properties[256] = {
    ...
    blockproperties_t().id(BlockID::golden_rail).tool(inventory::tool_type::pickaxe, inventory::tool_tier::no_tier).texture(163).opacity(0).transparent(true).solid(false).sound(SoundType::metal).aabb(flat_aabb).render_type(RenderType::flat_ground).collision(CollisionType::none).needs_support(true),
    ...
    blockproperties_t().id(BlockID::cobweb).tool(inventory::tool_type::sword, inventory::tool_tier::wood).texture(11).solid(false).opacity(0).transparent(true).sound(SoundType::stone).render_type(RenderType::cross).collision(CollisionType::none),
    ...
    blockproperties_t().id(BlockID::clay).tool(inventory::tool_type::shovel, inventory::tool_tier::no_tier).hardness(0.6f).texture(72).sound(SoundType::dirt),
