...
#include <blocks/block_snowlayer.hpp>
...
namespace registry
{
    void register_blocks()
    {
        ...
        (new BlockBase(BlockID::stone, 0, Materials::ROCK))->set_hardness(1.5f).set_resistance(10.0f).set_sound_type(BlockSoundType::stone);
        ...
        (new BlockSlab(BlockID::double_stone_slab, 6, true))->set_hardness(2.0f).set_resistance(10.0f).set_sound_type(BlockSoundType::stone);
        (new BlockSlab(BlockID::stone_slab, 6, false))->set_hardness(2.0f).set_resistance(10.0f).set_sound_type(BlockSoundType::stone);
        ...
        (new BlockTorch(BlockID::torch, 80))->set_hardness(0.0f).set_light_luminance(14).set_sound_type(BlockSoundType::wood);
        ...
        {
            if (!block_list[i])
                block_list[i] = new BlockBase(i, 0, Materials::AIR);
        }
    }
}
